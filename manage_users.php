          ...
          <?php while ($row = $result->fetch_assoc()) { ?>
            <tr class="hover:bg-gray-50 transition <?= ($row['status_id'] == 2) ? 'opacity-50 bg-gray-100' : ''; ?>">
              ...
              <td class="px-4 py-2 text-center space-x-2">
                ...
                <?php if ($row['status_id'] == 1) { ?>
                  <a href="toggle_user.php?id=<?= $row['admin_id']; ?>&status=2" 
                     class="text-yellow-500 hover:underline">Deactivate</a>
                <?php } else { ?>
                  <a href="toggle_user.php?id=<?= $row['admin_id']; ?>&status=1" 
                     class="text-green-500 hover:underline">Activate</a>
                <?php } ?>
                <a href="delete_user.php?id=<?= $row['admin_id']; ?>" 
